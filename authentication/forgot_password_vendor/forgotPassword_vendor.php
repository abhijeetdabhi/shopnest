        ...
        <form action="" method="post" id="form3" class="flex flex-col items-center gap-3">
            <div class="flex flex-col items-center gap-2">
                ...
                <div class="relative flex flex-col" x-data="{confirmPass: false}">
                    ...
                    <input name="confirmPass" id="confirmPass" :type="confirmPass ? 'text' : 'password'" class="w-[17rem] md:w-80 mt-2 h-12 pr-10 rounded-md border-2 border-gray-300 hover:border-gray-500 focus:border-gray-700 focus:ring-0 hover:transition" autocomplete="off">
            ...
            <div class="space-x-5 mt-3 flex items-center">
                <button id="back2" onclick="window.location.href='forgotPass_email_vendor.php'" type="button" class="bg-black px-2 w-28 md:w-32 text-white tracking-wide h-10 rounded-tl-xl rounded-br-xl flex items-center justify-center gap-1">
            ...
            <div class="text-center w-full py-2">
                <a href="../vendor_auth/vendor_login.php" class="inline-flex items-center gap-1">

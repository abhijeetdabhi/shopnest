                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 mt-3">
                    ...
                    <section class="container mx-auto p-6">
                        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg" id="place">
                            <div class="w-full overflow-x-auto h-max text-center">
                                <?php
                                    $get_orders = "SELECT * FROM orders WHERE vendor_id = '$vendor_id' AND user_id = '$user_id'";
                                    ...
                                    if (isset($_COOKIE['vendor_id'])) {
                                        ...
                                        if (mysqli_num_rows($get_orders_query) > 0) {
                                            ...
                                            if(in_array($vendor_id, $show_users)){
                                                continue;
                                            }

                                            $show_users[] = $vendor_id;
                                            // count orders
                                        ...
                                        ?>
                                                <tbody class="bg-white border">
                                                    <tr class="text-gray-700">
                                                        ...
                                                        <td class="px-3 py-2 border w-96"><img src="<?php echo isset($_COOKIE['vendor_id']) ? '../src/product_image/product_profile/' . $items['order_image'] : '../src/sample_images/product_1.jpg' ?>" alt="" class="w-full h-full object-contain m-auto"></td>
                    ...
                    <section class="container mx-auto p-6">
                        ...
                        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg" id="place">
                            <div class="w-full overflow-x-auto h-max text-center">
                                <?php
                                $get_cancle_orders = "SELECT * FROM cancel_orders WHERE vendor_id = '$vendor_id' AND user_id = '$user_id'";
                                        ...
                                        ?>
                                                <tbody class="bg-white border">
                                                    <tr class="text-gray-700">
                                                        ...
                                                        <td class="px-3 py-2 border"><img src="<?php echo isset($_COOKIE['vendor_id']) ? '../src/product_image/product_profile/' . $co['cancle_order_image'] : '../src/sample_images/product_1.jpg' ?>" alt="" class="w-28 h-full object-contain m-auto"></td>
                    ...
                    <section class="container mx-auto p-6">
                        ...
                        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
                            <div class="w-full overflow-x-auto h-max text-center">
                                <?php
                                $get_return_orders = "SELECT * FROM return_orders WHERE vendor_id = '$vendor_id'";
                                        ...
                                        ?>
                                                <tbody class="bg-white border">
                                                    <tr class="text-gray-700">
                                                        ...
                                                        <td class="px-3 py-2 border"><img src="<?php echo isset($_COOKIE['vendor_id']) ? '../src/product_image/product_profile/' . $ro['return_order_image'] : '../src/sample_images/product_1.jpg' ?>" alt="" class="w-28 h-full object-contain m-auto"></td>

            ...
            <div class="flex flex-col flex-1">
                ...
                <main id="main" class="overflow-y-auto scrollBar">
                    <div class="px-4 md:px-12 py-5">
                        <a href="multiAccount.php" class="w-fit bg-green-200 text-green-800 px-2 py-2 ring-1 ring-green-800 rounded-tl-lg rounded-br-lg flex items-center gap-2">
                            <span>

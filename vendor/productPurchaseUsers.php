        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
                ...
                <nav class="mt-10">
                    ...
                    <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="productPurchaseUsers.php">
                        <svg class="w-6 h-6 fill-gray-500 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 512 512.001" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                            <g>
                        ...
                        <span class="mx-3 text-[15px]">Product Purchase Users</span>
                    </a>
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                    ...
                    <section class="container mx-auto p-6">
                        <h2 class="font-manrope font-bold text-4xl leading-10 text-black mb-5">Product Purchase Users</h2>
                                        ...
                                        ?>
                                                <tbody class="bg-white border">
                                                    <tr class="text-gray-700">
                                                        ...
                                                        <td class="px-4 py-3 border w-96"><img src="<?php echo isset($_COOKIE['vendor_id']) ? '../src/product_image/product_profile/' . $items['order_image'] : '../src/sample_images/product_1.jpg' ?>" alt="" class="w-20 h-20 m-auto"></td>

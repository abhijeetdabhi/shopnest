        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0" x-cloak>
                ...
                <nav class="mt-10">
                    ...
                    <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="view_users.php">
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto scrollBar bg-gray-200">
                    <section class="container mx-auto p-6 text-center">
                                ...
                                ?>
                                        <div class="bg-white rounded-tl-2xl rounded-br-2xl shadow-lg text-center grid place-items-center overflow-hidden">
                                            <div class="flex justify-center mt-4">
                                                <img class="w-24 h-24 rounded-full object-cover" src="<?php echo isset($_COOKIE['adminEmail']) ? '../src/user_dp/' . $res['profile_image'] : '' ?>" alt="Profile Picture">
                                            </div>
                                            <div class="py-4">
                                                <h2 class=" text-xl font-semibold"><?php echo isset($_COOKIE['adminEmail']) ? $res['first_name'] . $res['last_name'] : '' ?></h2>
                                                <a href="mailto:<?php echo isset($_COOKIE['adminEmail']) ? $res['email'] : '' ?>" class="text-sm text-gray-500"><?php echo isset($_COOKIE['adminEmail']) ? $res['email'] : '' ?></a>
                                            </div>
                                            <div class="flex justify-between divide-x-2 border-t-2 w-full">
                                                <a href="tel:<?php echo isset($_COOKIE['adminEmail']) ? $res['phone'] : '' ?>" class="flex items-center justify-center space-x-1 w-full py-2 text-green-600">
                                                    <svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 480.56 480.56" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                                        <g>
                                            ...
                                            <div class="flex justify-between divide-x-2 border-t-2 w-full">
                                                <a href="userPurchaseProduct.php?user_id=<?php echo $res['user_id'] ?>" class="w-full flex justify-center items-center py-2 space-x-2 text-blue-600">
                                                    <span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class="w-6">
                                                            <g>
                                                                <path d="M24.526 501.31c25.004.004 37.725 0 37.208 0 6.218 0 11.574-3.515 14.359-8.625l10.307 4.982a64.51 64.51 0 0 0 27.905 6.389h90.851c11.953 0 21.676-9.723 21.676-21.678v-1.601c0-4.973-1.684-9.561-4.512-13.224 8.474-2.95 14.577-11.02 14.577-20.481v-3.121a21.54 21.54 0 0 0-3.919-12.416c1.018-.216 1.992-.544 2.953-.898h232.525c20.913 0 37.595-18.184 35.206-39.395-4.279-38.031-25.649-227.876-29.549-262.521-.178-1.61-1.665-3.453-3.132-4.002-.02-.007-.033-.023-.053-.031l-60.86-21.922v-5.78c0-48.287-39.267-88.226-87.533-89.034-50.452-.704-90.554 42.002-90.554 91.259v3.797l-59.582 21.461c-2.302.182-4.202 1.92-4.463 4.251l-18.168 161.413c-1.401-1.331-2.867-2.612-4.448-3.793-3.33-2.479-7.538-3.277-11.526-2.175a13.257 13.257 0 0 0-8.802 7.742l-13.77 33.05c-6.859 16.458-19.33 29.844-34.64 37.537-2.614-5.608-8.266-9.527-14.849-9.527H24.526c-9.051 0-16.416 7.362-16.416 16.416v115.512c0 9.053 7.365 16.415 16.416 16.415zm469.47-108.976c1.707 15.178-10.161 28.575-25.54 28.575H247.383a21.522 21.522 0 0 0 2.78-10.583v-2.061c0-9.856-6.612-18.197-15.634-20.819 2.543-3.464 4.05-7.714 4.156-12.307H492.06zm-83.928-279.228 31.356 11.294-32.499.127c2.347 12.78.372 1.61 1.143-11.421zm-.292 53.521c2.029 3.423 3.232 7.382 3.232 11.649 0 12.851-10.457 23.308-23.31 23.308-12.851 0-23.308-10.457-23.308-23.308 0-5.362 1.862-10.268 4.923-14.202.18 10.54 8.778 19.066 19.36 19.066 9.709 0 17.698-7.191 19.103-16.513zm-38.496-62.931v20.705H270.768v-20.705zm-100.352-9.728c1.695-27.798 25.849-49.742 54.955-47.012 23.963 2.256 43.025 22.491 45.181 47.012zm-29.219 5.244c0-43.6 35.496-82.194 80.665-81.532 42.991.717 77.967 36.294 77.967 79.306v66.759c0 5.329-4.337 9.666-9.666 9.666s-9.666-4.337-9.666-9.666V98.597c0-31.527-23.813-58.464-54.213-61.326-36.033-3.398-65.755 25.115-65.755 59.715v66.759c0 5.329-4.337 9.666-9.666 9.666s-9.666-4.337-9.666-9.666zm-9.581 65.989c.758 10.005 9.05 17.939 19.246 17.939 10.183 0 18.464-7.913 19.243-17.899 2.554 3.712 4.067 8.186 4.067 13.035 0 12.851-10.457 23.308-23.308 23.308-12.853 0-23.31-10.457-23.31-23.308a23.076 23.076 0 0 1 4.062-13.075zm-.147-51.852v11.052h-30.684zm-54.866 20.78h54.866v17.517c-8.239 6.007-13.642 15.675-13.642 26.631 0 18.216 14.82 33.035 33.038 33.035 18.216 0 33.035-14.82 33.035-33.035 0-10.957-5.403-20.617-13.644-26.619V134.13H371.28v16.783c-8.803 5.935-14.618 15.971-14.618 27.365 0 18.216 14.82 33.035 33.035 33.035 18.218 0 33.038-14.82 33.038-33.035 0-10.525-4.974-19.878-12.668-25.926v-18.221h54.866l26.032 231.283h-254.38c-3.48-7.329-10.895-12.445-19.535-12.445h-58.236l4.168-15.143c3.513-12.766 1.642-25.913-4.649-36.826zm-98.966 238.46c18.667-8.46 33.883-24.291 42.051-43.889l13.77-33.05c.594-1.425 1.755-1.928 2.394-2.104a3.552 3.552 0 0 1 3.137.594c12.808 9.557 18.344 25.692 14.1 41.101l-5.861 21.298a4.884 4.884 0 0 0 .822 4.242 4.865 4.865 0 0 0 3.869 1.914h64.62c6.588 0 11.948 5.358 11.948 11.946s-5.36 11.951-11.948 11.951h-41.744c-2.686 0-4.864 2.175-4.864 4.864s2.178 4.864 4.864 4.864h53.182c6.588 0 11.948 5.358 11.948 11.946v2.061c0 6.588-5.36 11.946-11.948 11.946H176.22a4.862 4.862 0 0 0-4.864 4.864 4.863 4.863 0 0 0 4.864 4.864h38.999c6.59 0 11.951 5.363 11.951 11.951v3.121c0 6.574-5.351 11.936-11.925 11.951l-39.493.081a4.864 4.864 0 0 0 .01 9.728h29.395c6.588 0 11.948 5.358 11.948 11.946v1.601c0 6.588-5.36 11.951-11.948 11.951h-90.851a54.76 54.76 0 0 1-23.673-5.42l-12.483-6.032v-110.29zM50.154 491.582H36.106v-22.804c0-3.876 3.152-7.025 7.023-7.025a7.031 7.031 0 0 1 7.025 7.025zM17.838 369.383c0-3.686 3-6.688 6.688-6.688h37.208a6.697 6.697 0 0 1 6.688 6.688v115.512c0 3.686-3 6.688-6.688 6.688h-1.852v-22.804c0-9.238-7.514-16.753-16.753-16.753-9.236 0-16.75 7.514-16.75 16.753v22.804h-1.852a6.697 6.697 0 0 1-6.688-6.688V369.383z" fill="currentColor" opacity="1" data-original="currentColor"></path>
                                                            </g>
                                                        </svg>
                                                    </span>
                                    ...
                                    ?>
                                    <div class="col-span-full font-bold text-xl md:text-2xl w-max m-auto py-4">No User Found for this period.</div>
                                <?php
                                }
                                ?>
                            </div>
                        ...
                        ?>
                            <div class="font-bold text-xl md:text-2xl w-max m-auto py-4">No User Found for this period.</div>
                        <?php
                        }
                        ?>
                    </section>

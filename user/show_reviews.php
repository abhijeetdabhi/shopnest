        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0" x-cloak>
                ...
                <nav class="mt-10">
                    ...
                    <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="show_reviews.php">
                        <svg class="w-6 h-6 fill-white" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 512.002 512.002" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                            <g>
            ...
            <div class="flex flex-col flex-1">
                ...
                <div class="px-1 md:px-6 py-8 mx-auto bg-gray-200 w-full">
                    <h3 class="text-3xl font-medium">Your reviews</h3>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex my-2">
                                                ...
                                                <div class="mt-3 px-3 space-y-1 w-full">
                                                    <h1 class="font-medium line-clamp-1 pr-2" title="<?php echo isset($_COOKIE['user_id']) ? $rev['Headline'] : 'Headline' ?>">Title: <?php echo isset($_COOKIE['user_id']) ? $rev['Headline'] : 'Headline' ?></h1>
                                                    <p class="text-sm line-clamp-4" title="<?php echo isset($_COOKIE['user_id']) ? $rev['description'] : 'description' ?>">
                                                        <span class="font-semibold">Description :</span>
                                                        <?php echo isset($_COOKIE['user_id']) ? $rev['description'] : 'description' ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>

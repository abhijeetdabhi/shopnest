    ...
    <div>
        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-white">
            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0" x-cloak>
                ...
                <nav class="mt-10">
                    <a class="group flex items-center px-6 py-2 mt-4 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="profile.php">
                        <svg class="w-6 h-6 fill-gray-500 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
            ...
            <div class="flex flex-col flex-1">
                ...
                <form action="" method="post" class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200" onsubmit="return validateForm()">
                    <div class="container px-6 py-8 mx-auto">
                        <h3 class="text-3xl font-medium">Address</h3>
                            ...
                            <div class="bg-white max-h-max rounded-md shadow-lg p-8">
                                ...
                                <div class="mt-12 grid grid-cols-1 gap-y-5 gap-x-3 md:grid-col-2">
                                    <div class="col-span-1">
                                        <label for="address" class="require">Your address:</label>
                                        <input type="text" name="address" id="address"
                                            value="<?php echo isset($_COOKIE['user_id']) ? $row['Address'] : 'Sign In' ?>"
                                            class="border mt-1 rounded px-4 w-full bg-gray-50 focus:border-gray-500 focus:ring-2 focus:ring-gray-500">
                                        <small id="address-error" class="text-red-500 translate-x-1 hidden">Address is required</small>
                                    </div>
                                    <div class="col-span-1">
                                        <label for="state" class="require">State:</label>
                                        <input type="text" name="state" id="state"
                                            value="<?php echo isset($_COOKIE['user_id']) ? $row['state'] : 'Sign In' ?>"
                                            class="border mt-1 rounded px-4 w-full bg-gray-50 focus:border-gray-500 focus:ring-2 focus:ring-gray-500">
                                        <small id="state-error" class="text-red-500 translate-x-1 hidden">State is required</small>
                                    </div>
                                    <div class="flex gap-5">
                                        <div class="w-full">
                                            <label for="city" class="require">City:</label>
                                            <input type="text" name="city" id="city"
                                                value="<?php echo isset($_COOKIE['user_id']) ? $row['city'] : 'Sign In' ?>"
                                                class="border mt-1 rounded px-4 w-full bg-gray-50 focus:border-gray-500 focus:ring-2 focus:ring-gray-500">
                                            <small id="city-error" class="text-red-500 translate-x-1 hidden">City is required</small>
                                        </div>
                                        <div class="w-full">
                                            <label for="Pincode" class="require">Pincode:</label>
                                            <input type="number" name="Pincode" id="pincode"
                                                value="<?php echo isset($_COOKIE['user_id']) ? $row['pin'] : '' ?>"
                                                class="border mt-1 rounded px-4 w-full bg-gray-50 focus:border-gray-500 focus:ring-2 focus:ring-gray-500">
                                            <small id="pincode-error" class="text-red-500 translate-x-1 hidden">Pincode is required</small>
                                        </div>
                                    </div>
                                </div>
                ...
                <script>
                    function validateForm() {
                        // Get input fields and their default values
                        ...
                        // Function to validate a field and show/hide the error message
                        ...
                        validateField(stateInput, stateError);
                        validateField(cityInput, cityError);
                        validateField(pincodeInput, pincodeError);

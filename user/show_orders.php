                                                        ...
                                                        <div class="flex items-center">
                                                            <div class="">
                                                                ...
                                                                <div class="flex items-center divide-x-2 divide-gray-400">
                                                                    <p class="font-medium text-base leading-7 px-2 text-black inline-flex gap-1"> Qty: <span class="text-gray-500 mt-[1px]"><?php echo isset($_COOKIE['user_id']) ? $res['qty'] : 'product quantity' ?></span></p>
                                                                    <p class="font-medium text-base leading-7 px-2 text-black inline-flex gap-1">Price: <span class="text-gray-600 mt-[1px]">₹<?php echo isset($_COOKIE['user_id']) ? $res['total_price'] : 'product total_price' ?></span></p>
                                                                </div>
                                                            </div>
                                                        </div>

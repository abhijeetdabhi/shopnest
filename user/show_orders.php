            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0" x-cloak>
                ...
                <nav class="mt-10">
                    ...
                    <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="show_orders.php">
                        <svg class="w-6 h-6 fill-white" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 96 96" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                            <g>
                            ...
                            ?>
                                    <div class="flex flex-col md:flex-row items-center py-5 bg-gray-100 px-5 gap-6 w-full mb-7 rounded-xl shadow-lg md:h-44">
                                        ...
                                        <div class="flex flex-col md:flex-row justify-between items-start w-full">
                                            ...
                                            <div class="flex items-center mt-4 md:mt-0 space-x-3 md:space-x-6">
                                                <div class="text-center space-y-2">
                                                    <p class="font-medium text-black">Status</p>
                                                    <?php
                                                    ...
                                                    $date2->modify("+" . floor($travelTime / 3) . " minutes");
                                                    $time2Formatted = $date2->format("h:i:s A");
                                                    $date3->modify("+" . floor($travelTime / 2) . " minutes");

                            ...
                            <?php
                                if(isset($_COOKIE['user_id'])){
                                    ...
                                    while($res = mysqli_fetch_assoc($retrieve_order_query)){
                                        ...
                                        ?>
                                            <div class="flex flex-col md:flex-row items-center py-6 border-b-2 border-gray-300 gap-6 w-full">
                                                    ...
                                                    <div class="grid grid-cols-1 lg:grid-cols-2 w-full">
                                                        <div class="flex items-center">
                                                            <div class="">
                                                                ...
                                                                <div>
                                                                    <p class="font-medium text-base leading-7 text-black inline-flex gap-1">Price: <span class="text-gray-600 mt-[1px]">₹<?php echo isset($_COOKIE['user_id']) ? $res['cancle_order_price'] : 'cancle_order_price' ?></span></p>
                                                                </div>
                                                            </div>
                                                        </div>

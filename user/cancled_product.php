                                        ...
                                        <div class="flex flex-col md:flex-row justify-between items-start md:items-center w-full gap-4 md:gap-6 lg:gap-10">
                                            ...
                                            <div class="flex items-center justify-between md:justify-normal gap-5 md:gap-10 w-full md:w-auto">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <span class="inline-block px-4 py-1 rounded-tl-lg rounded-br-lg bg-red-100 text-red-600 text-sm font-medium">
                                                        Canceled
                                                    </span>
                                                </div>
                                                <!-- Canceled Date -->
                                                <div class="text-center">
                                                    <p class="text-sm md:text-base md:font-medium text-gray-700 mb-1">Canceled Date</p>

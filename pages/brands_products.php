...
<head>
    ...
    <title><?php echo isset($company_name) ? $company_name : 'Product company_names' ?></title>
    ...
    <div class="px-3 sm:px-16 outfit mt-5" id="main-content">
        ...
        <div class="flex jutify-center">
            <div class="mt-7 w-64 hidden lg:block">
                <form method="post">
                    ...
                    <div class="border-b-2 border-gray-300 pb-4 mt-3">
                        ...
                        <div class="mt-3 text-gray-600">
                            <ul class="space-y-2 text-gray-700">
                                <?php
                                $select_color = "SELECT * FROM products WHERE company_name = '$company_name'";
                    ...
                    <div class="border-b-2 border-gray-300 pb-4 mt-3">
                        ...
                        <div class="mt-2 text-gray-700">
                            <ul class="space-y-2">
                                <?php
                                $select_size = "SELECT size FROM products WHERE company_name = '$company_name'";
                ...
                if ($filter_query) {
                    $products = "SELECT * FROM products WHERE company_name = '$company_name' AND $filter_query";
